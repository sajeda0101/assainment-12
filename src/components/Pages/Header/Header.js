  ...
  const menuItem = (
    <>
      <li>
        <Link
          to="/"
          className="   hover:bg-indigo-600 hover:text-white rounded"
        >
          Home
        </Link>
      </li>
      ...
      {user?.uid ? (
        ...
        <li>
          <Link
            to="/login"
            className=" mr-1 text-xl hover:bg-indigo-600 hover:text-white rounded"
          >
            Login
          </Link>
        </li>
    ...
    <div className="navbar bg-slate-200 lg:px-24 text-black">
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <ul
            tabIndex={0}
            className="menu menu-compact  dropdown-content mt-3 p-2  rounded bg-slate-200  w-52"
          >
            {menuItem}
          </ul>
        </div>
